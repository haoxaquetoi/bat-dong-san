ngApp.controller('articleCrawlerListCtrl', function ($scope, $apply, $articleService,
        category,
        post_date,
        count,
        arrArticle,
        ...
        )
{
    ...
    $scope.actions = {
        getAll: function ()
        {
            window.location.href = SiteUrl + '/admin/articleCrawler?' + $httpParamSerializer($scope.data.filter);
        },
        ...
        detailFeedback: function (postInfo)
        {
            ...
            //load danh sách feedback_articleCrawler
