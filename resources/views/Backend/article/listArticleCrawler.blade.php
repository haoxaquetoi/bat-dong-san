...
<script src="{{ URL::asset('backend/js/article/articleCrawlerListCtrl.js') }}"></script>
@endsection
@section('content')
...
<section class="content-header">
    <h1>
        Danh sách tin đồng bộ crawler
    </h1>
</section>
<!-- Main content -->
<section class="content" ng-controller="articleCrawlerListCtrl" ng-cloak="">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <div class="row padding-bottom-10">
                        <div class="col-xs-12">
                           ...
                           | <a ng-class="data.filter.option != 'Trash' ? 'text-black' : ''" href="javascript:;" ng-click="data.filter = {};data.filter.option = 'Trash';actions.getAll()" >Chưa duyệt (@{{count.total_trash}})</a> 
                                ...
                                <table  class="table table-bordered table-hover dataTable" role="grid" id="example2" >
                                    ...
                                    <tbody>
                                        <tr ng-repeat="article in data.arrArticle.data">
                                            ...
                                            <td class="tbl-actions text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{url('admin/article/singleProductCrawler')}}/@{{article.id}}">Chi tiết</a></li>
                                            ...
                                            <td>
                                                <a  ng-if="article.deleted ==1" href="{{url('admin/articleCrawler/singleProductCrawler')}}/@{{article.id}}"  ><strike>@{{article.title}}</strike></a>
                                                <a  ng-if="article.deleted !=1" href="{{url('admin/articleCrawler/singleProductCrawler')}}/@{{article.id}}"  >@{{article.title}}</a>
                                            </td>
