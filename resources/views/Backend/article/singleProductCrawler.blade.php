...
<script src="{{ URL::asset('backend/js/article/singleProductCrawlerCtrl.js') }}"></script>
@endsection
@section('content')

<angular ng-cloak="" ng-controller="singleProductCrawlerCtrl">
    <section class="content-header">
        <h1>
            Duyệt tin đồng bộ
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{url('admin/articleCrawler')}}"><i class="fa fa-dashboard"></i> Quản lý tin đồng bộ</a></li>
            <li class="active">Duyệt tin đồng bộ</li>
        </ol>
    </section>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group clearfix">
                                <div class="col-xs-6" style="padding: 0 3px 10px 0">
                                    <div class="form-group">
                                        <input  type="checkbox"   class="magic-checkbox" ng-checked="articleInfo.crawlerPublish == 1" ng-click="articleInfo.crawlerPublish = !articleInfo.crawlerPublish"  name=isCrawlerPublish" id="crawlerPublish" >
                                        <label for="crawlerPublish" class="padding-right-20" >
                                            Duyệt tin
                                        </label>
                                    </div>
                                </div>
